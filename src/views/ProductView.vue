        ...
        <div class="container">
            <div class="products-slider">
                ...
                <ul class="products-slider__info">
                    ...
                    <li class="products-slider__info-item"></li>
                </ul>
            ...
            <!-- <section class="section section--reviews">
                <h2 class="sectionj-title">Отзывы</h2>
                <div class="reviews">
                    ...
                    <ul class="reviews__list">
                        <li class="reviews__item">
                            <div class="rewievs__item-header">
                                ...
                                <div class="reviews__item-name">Татьяна</div>
                            </div>
                        ...
                        <li class="reviews__item">
                            ...
                            <p class="rewievs__item-text">
                                Покупали в том числе в этом весе. Масло по вкусу
                                и органолептическим свойствам совершенно не
                                похоже на натуральное. Упаковка выглядит как
                                напечатанная на дешёвом принтере. На наш взгляд
                                продукт является подделкой или контрафактной
                    ...
                    <form class="reviews-form">
                        ...
                        <textarea class="reviews-form__textarea">
                            Отзыв
                        </textarea>
